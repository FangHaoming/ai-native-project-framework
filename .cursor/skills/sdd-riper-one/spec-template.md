...
- **Complete when**: TBD
- **Evidence**: TBD
- **Still incomplete when**: TBD

## 1.1 Context Sources

- Requirement Source: TBD
- Design Refs: None
- Chat/Business Refs: None
- Extra Context: None
...
- Key Index:
  ...
  - Dependencies / External Systems: TBD
...
- Facts and constraints: TBD
- Risks and uncertainties: TBD
...
- Commands: pending
- Screenshots: pending or not applicable
- Logs: pending
...
| --- | --- | --- | --- |
| Spec Quality & Requirement Completion | Goal, scope, acceptance, completion | PENDING | pending |
| Spec-Code Fidelity | Files, signatures, checklist, behavior | PENDING | pending |
| Code Intrinsic Quality | Correctness, robustness, maintainability, tests, risk | PENDING | pending |
